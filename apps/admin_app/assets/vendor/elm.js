				...
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(model.active)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$StockLocations_List$initialModel = {stockLocations: _krisajenkins$remotedata$RemoteData$NotAsked};
...
var _user$project$StockLocations_List$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('StockLocations--container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$StockLocations_List$SendHttpRequest),
						_1: {
							ctor: '::',
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Fetch Stock Locations'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('thead-dark'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
